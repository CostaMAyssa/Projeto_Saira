      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <Card className="bg-pharmacy-dark2 border-pharmacy-dark1">
          <CardHeader className="pb-2">
            ...
            <CardDescription className="text-pharmacy-green2 text-xs">
              Últimas 24 horas
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold text-white">28</div>
            <p className="text-sm text-pharmacy-green2">↑ 12% em relação a ontem</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-pharmacy-dark2 border-pharmacy-dark1">
          ...
          <CardContent>
            ...
            <p className="text-sm text-pharmacy-green2">↑ 5% em relação ao mês anterior</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-pharmacy-dark2 border-pharmacy-dark1">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-white">215</div>
            <p className="text-sm text-pharmacy-green2">↑ 8% em relação ao mês anterior</p>
          </CardContent>
        </Card>
      </div>
