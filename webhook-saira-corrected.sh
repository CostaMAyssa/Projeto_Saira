...
echo "🔧 Reconfigurando webhook com URL correta da Saira..."
...
echo ""
echo ""
echo "🎯 Webhook reconfigurado com a URL correta da Saira! Agora teste enviando uma mensagem para o WhatsApp da instância."